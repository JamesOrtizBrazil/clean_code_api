...
describe('DbASurveyResult Usecase', () => {
  beforeAll(() => {
  ...
  test('Should call LoadSurveyResultRepository with correct values', async () => {
    ...
    const loadVySurveyIdSpy = jest.spyOn(loadSurveyResultRepositoryStub, 'loadBySurveyId')
    const surveyResultData = mockSaveSurveyResultParams()
    await sut.save(surveyResultData)
    expect(loadVySurveyIdSpy).toHaveBeenCalledWith(surveyResultData.surveyId)
  })
